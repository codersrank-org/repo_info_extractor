...
def test_languages_recognised():
    ...
    assert detect_language.detect_language("/tmp/some_file.lvproj") == "LabVIEW"
    assert detect_language.detect_language("/tmp/some_file.lvclass") == "LabVIEW"
    ...
    assert detect_language.detect_language("/tmp/some_file.lvbitx") == "LabVIEW"
    ...
    assert detect_language.detect_language("/tmp/some_file.lvmodel") == "LabVIEW"
    assert detect_language.detect_language("/tmp/some_file.lvsc") == "LabVIEW"
    assert detect_language.detect_language("/tmp/some_file.lvtest") == "LabVIEW"
