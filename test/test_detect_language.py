...
def test_languages_recognised():
    ...
    assert detect_language.detect_language("/tmp/some_file.jsx") == "JavaScript"
    ...
    assert detect_language.detect_language("/tmp/some_file.coffee") == "CoffeeScript"
    ...
    assert detect_language.detect_language("/tmp/some_file.mm") == "Objective-C"
    assert detect_language.detect_language("/tmp/some_file.pl") == "Perl"
    assert detect_language.detect_language("/tmp/some_file.php") == "PHP"
    assert detect_language.detect_language("/tmp/some_file.proto") == "Protocol Buffer"
    ...
    assert detect_language.detect_language("/tmp/some_file.tsx") == "TypeScript"
